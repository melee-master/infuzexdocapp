...
import { DoctorResetPasswordAction } from "../actions/doctoraction";
...
const DoctorResetPassword = () => {
    ...
    const resetpassword = (e) => {
        ...
        if (password == cpassword) {
            dispatch(DoctorResetPasswordAction(userid, password))
            document.getElementById('right-password').innerHTML = "Your Password has been Updated! Please Login"
            setTimeout(function () { window.location.href = '/drlogin' }, 2000);
        }
        else {
